...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv1d(64, 256, kernel_size=3, stride=2, padding=0)
        self.conv4 = nn.Conv1d(256, 300, kernel_size=7, stride=2, padding=0)
        ...
        self.fc1 = torch.nn.Linear(300*5, 300)
        self.fc2 = torch.nn.Linear(300, 128)
        self.fc3 = torch.nn.Linear(128, 128)
        self.fc4 = torch.nn.Linear(128, 26)
